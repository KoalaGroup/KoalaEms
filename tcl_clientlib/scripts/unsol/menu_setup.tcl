...
proc create_menu_setup {parent} {
  ...
  menu $self -title "EMSunsol Setup"
  ...
  $self add command -label "Log File ..." -underline 0 \
      -command logfile_win_open

  $self add checkbutton -label "Autolog" -underline 0 \
      -variable global_setup(auto_log)\
      -selectcolor black
