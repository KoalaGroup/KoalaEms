# $Id: unsol_runtime_ExecProcList.tcl,v 1.1 2000/08/31 15:43:11 wuestner Exp $
# copyright 2000
...
trigger $trigid:" tag_red
  ...
  set ved [set vedsetup_${space}::ved]
  set islist [$ved namelist is]
  set iss 0
  foreach is $islist {
    set id [$ved is id $is]
    if {$id==$isid} {
