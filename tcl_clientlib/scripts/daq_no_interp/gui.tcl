# $Id: gui.tcl,v 1.8 1999/05/07 15:17:50 wuestner Exp $
# copyright:
...
static char schrumpf-logo_bits[] = {
 ...
 0x00,0xfe,0xff,0x1f,0xf0,0x00,0xfc,0xff,0x07,0xf0,0x00,0xf0,0xff,0x01,0xf0
  ...
  image create bitmap fzj -foreground #01a0c6 -data {
...
static unsigned char screen-logo_bits[] = {
  ...
  entry .sp.status.e4 -textvariable global_daq(stoptime) -relief flat\
    -state disabled
  label .sp.status.l5 -text "Zentrallabor für Elektronik (ZEL)"\
    -background #01a0c6 -foreground white -cursor {} -padx 2 -pady 2\
    -font {Helvetica -12 bold roman}
...
#  grid configure .sp.status.l5 -column 0 -row 4 -sticky we -columnspan 4
