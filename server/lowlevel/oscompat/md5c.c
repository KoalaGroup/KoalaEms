...
static const char* cvsid __attribute__((unused))=
    "$ZEL: md5c.c,v 1.2 2011/04/06 20:30:27 wuestner Exp $";

#include "../../conf/sconf.h"
#include <rcs_ids.h>
...
#else
#define MD5_memset(output, c, len) memset((output), (c), (len))
#endif
...
#else
#define Decode(output, input, len) memcpy((output), (input), (len))
#endif
