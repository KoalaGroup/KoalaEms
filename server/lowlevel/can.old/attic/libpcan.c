...
//
// $Log: libpcan.c,v $
// Revision 1.1  2006/09/15 18:16:09  wuestner
// initial version
//
// Revision 1.1  2006/04/20 09:48:33  peterka
// initial version
//
...
#if 0
static DWORD LINUX_CAN_Read_Timeout(HANDLE hHandle, TPCANRdMsg* pMsgBuff, int nMicroSeconds)
{
	int err = EBADF;
...
#if 0
static DWORD LINUX_CAN_Extended_Status(HANDLE hHandle, int *nPendingReads, int *nPendingWrites)
{
  PCAN_DESCRIPTOR *desc = (PCAN_DESCRIPTOR *)hHandle;
  int err = EBADF;
