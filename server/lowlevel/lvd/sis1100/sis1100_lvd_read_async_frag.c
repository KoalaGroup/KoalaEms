...
static const char* cvsid __attribute__((unused))=
    "$ZEL: sis1100_lvd_read_async_frag.c,v 1.1 2015/11/18 15:40:47 wuestner Exp $";


#error This is the old version with defragmenting fragmented events.
#error Because defragmenting is unnecessary in asynchronous mode the
#error new version will leave fragmented events fragmented.
#error (The reason for defragmenting was to simplify the decoding, but this is
#error nonsense.)
