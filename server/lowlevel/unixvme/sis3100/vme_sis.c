...
static const char* cvsid __attribute__((unused))=
    "$ZEL: vme_sis.c,v 1.52 2011/08/13 20:09:08 wuestner Exp $";
...
VME-Controller.
It can be a real VME interrupt, a sis3100 front paneel IRQ or a s1100 LEMO IRQ.
...
/*****************************************************************************/
static int
vme_acknowledge_irq(struct vme_dev* dev, ems_u32 mask, ems_u32 vector)
{
    struct vme_sis_info* info=(struct vme_sis_info*)dev->info;
...
/*****************************************************************************/
static void
sis3100_irq(int p, enum select_types selected, union callbackdata data)
{
