/*
 * lowlevel/unixvme/sis3100/load_dsp.c
 * created 27.Jun.2003 PW
 */
static const char* cvsid __attribute__((unused))=
    "$ZEL: load_dsp.c,v 1.5 2011/04/06 20:30:28 wuestner Exp $";
...
/*===========================================================================*/
static int
load_dsp(int p, u_int8_t* code, u_int32_t addr, size_t nr_bytes)
{
    ssize_t res;
    size_t idx;
...
#endif
#if 0
        printf("%c%c%c%c%c%c", w[0], w[1], w[2], w[3], w[4], w[5]);
#endif
        w0=w[5]|(w[4]<<8);
