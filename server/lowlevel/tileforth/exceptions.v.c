...
COMPILATION_CODE(parenexceptionsemicolon, exception, "(exception;)",
    doparenexceptionsemicolon)
...
COMPILATION_CODE(parenexceptionunlinksemicolon, parenexceptionsemicolon,
    "(exceptionunlink;)", doparenexceptionunlinksemicolon)
...
COMPILATION_CODE(parenexception, parenexceptionunlinksemicolon,
    "(exception>)", doparenexception)
...
COMPILATION_IMMEDIATE_CODE(exceptionsharp, parenexception, "exception>",
    doexceptionsharp)
