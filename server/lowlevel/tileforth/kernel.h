...
#define spop(t)       (sp++)->t
#define sdrop()        sp++
#define sndrop(n)      sp+=(n)+1
#define snip()         sp[1]=sp[0], sp++
#define binary(o, t)   (sp++)[1].t = sp[1].t o sp[0].t
#define relation(o, t) sp[1].BOOL=((sp[1].t o sp[0].t)?TRUE:FALSE), sp++
#define sinit() sp=s0
#define spush(e, t) (--sp)->t=(e)
#define snth(n) sp[(n)+1]
#define sdup()  sp--, sp[0]=sp[1]
#define sover() sp--, sp[0]=sp[2]
#define stuck() sp--, sp[0]=sp[1], sp[1]=sp[2], sp[2]=sp[0]
#define sswap() sp[-1]=sp[0], sp[0]=sp[1], sp[1]=sp[-1]
#define srot()  sp[-1]=sp[2], sp[2]=sp[1], sp[1]=sp[0], sp[0]=sp[-1]
#define sdashrot() sp[-1]=sp[0], sp[0]=sp[1], sp[1]=sp[2], sp[2]=sp[-1]

#define coerce(f, t) sp->t = (t)sp->f
#define unary(o, t) sp->t = o sp->t
#define compare(o, t) sp->BOOL = (sp->t o ? TRUE : FALSE)
