...
static const char* cvsid __attribute__((unused))=
    "$ZEL: v560.c,v 1.4 2011/04/06 20:30:35 wuestner Exp $";
 ...
 * p[0]: argcount==0
 */
plerrcode proc_v560clear(ems_u32* p)
{
    int i, res;
 ...
 * p[0]: argcount==0
 */
plerrcode proc_v560read(ems_u32* p)
{
    int i, j, res;
 ...
 * p[0]: argcount==0
 */
plerrcode proc_v560status(ems_u32* p)
{
    int i, res;
 ...
 * p[0]: argcount==0
 */
plerrcode proc_v560incr(ems_u32* p)
{
    int i, res;
