/*
 * commu_local_server_i.hxx.m4
 * 
 * $ZEL: commu_local_server_i.hxx.m4,v 2.8 2009/08/21 22:02:28 wuestner Exp $
 * 
 * created 30.07.94 PW
 */

#ifndef _commu_local_server_i_hxx_
#define _commu_local_server_i_hxx_

#include <commu_local_server.hxx>

/*****************************************************************************/

class C_local_server_i: public C_local_server
  {
  public:
    C_local_server_i(const char*, en_policies);
    virtual ~C_local_server_i();

    typedef struct
      {
      plerrcode (C_local_server_i::*proc)(const ems_u32*);
      plerrcode (C_local_server_i::*test_proc)(const ems_u32*);
    ...
    typedef struct
      {
      procprop* (C_local_server_i::*prop_proc)();
      } listprop;
