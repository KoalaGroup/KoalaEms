/*
 * ems/events++/event2tade_2007.hxx
 * 
...
#ifndef _event2tade_hxx_
#define _event2tade_hxx_
...
int decode_to_tade_2007(deque<sev_object>& event, ems_object& ems,
        int nr_files, compressed_output*, int* n=0);
void clear(void);
