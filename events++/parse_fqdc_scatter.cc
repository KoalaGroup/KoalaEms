/*
 * ems/events++/parse_fqdc_scatter.cc
 * 
 * created 2006-Jul-25 PW
 */
...
"$ZEL: parse_fqdc_scatter.cc,v 1.1 2006/09/15 17:29:41 wuestner Exp $")
#define XVERSION
...
{
    int code=(v>>16)&0x3f;
    if ((code==0) && (chan==selchan)) {
        cout<<qdc_idx[chan]<<"\t"<<(v&0xfff)<<endl;
        qdc_idx[chan]++;
    }
