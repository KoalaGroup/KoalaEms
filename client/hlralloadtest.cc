...
"$ZEL: hlralloadtest.cc,v 2.2 2004/11/26 22:20:42 wuestner Exp $")
...
ral_check_matrix(int board, int crate, ral_testmatrix& testmatrix)
{
    ...
    ral_testreadout_matrix(board, testmatrix.ematrix, 1);
...
do_something()
{
    ...
    switch (oper[0]) {
        case 'a': generator=ral_testmatrix::gen_and; break;
        case 'o': generator=ral_testmatrix::gen_or; break;
        case 'x': generator=ral_testmatrix::gen_xor; break;
        default:
